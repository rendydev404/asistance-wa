  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 md:space-y-8">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-teal-300">Control center</p>
        ...
        <div className="flex items-center gap-2 text-xs font-medium text-slate-400">
          <span className="h-2 w-2 animate-pulse rounded-full bg-teal-300" /> Data tersinkron otomatis
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4">
        <div className="rounded-3xl border border-white/8 bg-[#0e1c2d] p-4 sm:p-5">
          <div className="flex items-center justify-between"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-teal-300/12 text-teal-200"><Activity className="h-4 w-4" aria-hidden="true" /></span><span className="text-[10px] font-bold uppercase tracking-widest text-teal-300">Live</span></div>
          <p className="mt-5 text-2xl font-bold text-white">Aktif</p><p className="mt-1 text-xs text-slate-500">Mesin balas AI</p>
        </div>
        <div className="rounded-3xl border border-white/8 bg-[#0e1c2d] p-4 sm:p-5">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-300/12 text-cyan-200"><BookOpen className="h-4 w-4" aria-hidden="true" /></span>
      ...
      <section>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <Link href="/admin/knowledge" className="group flex min-h-20 items-center justify-between rounded-3xl border border-white/8 bg-[#0e1c2d] p-4 transition hover:-translate-y-0.5 hover:border-teal-300/40 hover:bg-[#12243a]">
            <span className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-teal-300/12 text-teal-200"><BookOpen className="h-5 w-5" aria-hidden="true" /></span><span><span className="block text-sm font-semibold text-white">Isi knowledge base</span><span className="mt-1 block text-xs text-slate-500">Tambah fakta agar jawaban lebih tepat</span></span></span><ArrowUpRight className="h-5 w-5 text-slate-500 transition group-hover:-translate-y-0.5 group-hover:text-teal-200" aria-hidden="true" />
          </Link>
          <Link href="/admin/exclusions" className="group flex min-h-20 items-center justify-between rounded-3xl border border-white/8 bg-[#0e1c2d] p-4 transition hover:-translate-y-0.5 hover:border-amber-300/40 hover:bg-[#12243a]">
            <span className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-amber-300/12 text-amber-200"><ShieldCheck className="h-5 w-5" aria-hidden="true" /></span><span><span className="block text-sm font-semibold text-white">Atur nomor pengecualian</span><span className="mt-1 block text-xs text-slate-500">Alihkan chat tertentu ke admin</span></span></span><ArrowUpRight className="h-5 w-5 text-slate-500 transition group-hover:-translate-y-0.5 group-hover:text-amber-200" aria-hidden="true" />
          </Link>
        </div>
      </section>
    </div>
